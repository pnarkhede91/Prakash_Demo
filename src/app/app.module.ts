...
const appRoutes=[
					...
					{path:'Customer/:id1' , component:EmployeesComponent,canActivate: [LoggedInGuard]},
...
@NgModule({
  declarations: [
    ...
    HomeComponent,
    LoginComponent,
    MiscComponent,EmployeesSalaryPipe,EmployeeComponentView,SearchFilterPipe, StaffComponent, ShopComponent, CompanyComponent, ProductComponent ,dateFormatPipe, LogoutComponentComponent,headerMenu, NewOrderComponent, ViewOrderComponent,ViewOrderComponent, ViewOrderDetailsComponent
  ],
  imports: [
	...
	BsDatepickerModule.forRoot(),Ng2TableModule,NgxPermissionsModule.forRoot()
  ],
